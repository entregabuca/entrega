Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "entrega_#{Rails.env}"
  ...
  config.i18n.fallbacks = [I18n.default_locale] #true CHANGED BECAUSE IT WAS UPDATED AND THE WARNING MESSAGE
