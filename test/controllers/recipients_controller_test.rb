...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { email: @recipient.email, name: @recipient.name, order_id: @recipient.order_id, telephone: @recipient.telephone } }
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { email: @recipient.email, name: @recipient.name, order_id: @recipient.order_id, telephone: @recipient.telephone } }
